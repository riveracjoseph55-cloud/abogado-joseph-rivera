...
export const RC_CASES = [
  ...
  },
  {
    ...
    hechos: "El domingo 16 de noviembre de 2025, clientes habituales de Finca Lajas llegaron temprano al restaurante y encontraron una escena que describieron como «terrible»: Antonio «Toño» Badilla (80 años) y su esposa Maureen Molina (65 años) yacían sin vida en su hogar. El reporte al OIJ ingresó a las 8:32 a.m. Ambas víctimas presentaban múltiples heridas causadas por arma blanca. Toño y Maureen eran los fundadores y alma del restaurante Finca Lajas — un espacio reconocido en la zona sur de San José por sus senderos, su cocina casera y la calidez genuina de sus dueños, quienes durante años convirtieron la finca en punto de encuentro de senderistas, familias y vecinos de toda la comunidad. La noticia del doble homicidio sacudió profundamente a Alajuelita.",
    desafio: "El principal sospechoso, identificado como Mairena (28 años, de origen nicaragüense), era un peón que trabajaba directamente para la pareja y que —según testimonios de vecinos— había recibido apoyo económico de los propios Badilla-Molina. El vínculo de confianza entre víctimas y agresor constituye una circunstancia agravante que la estrategia jurídica debe acreditar plenamente. La reconstrucción técnica de los hechos —realizada en la escena del crimen en mayo de 2026— es una pieza procesal clave para consolidar la cadena probatoria y determinar exactamente cómo ocurrió el ataque.",
    estrategia: "El Lic. Rivera Cheves asumió la dirección del caso como querellante privado en representación de los familiares, contando con el apoyo técnico del Lic. Álvaro Borbón Barrantes: abogado, notario y criminólogo con más de 30 años de experiencia investigativa en el OIJ, especializado en análisis de escena del crimen y cadena de custodia. La estrategia combina la construcción de una plataforma probatoria sólida —ancla en la reconstrucción in situ de mayo 2026— con la exigencia de las penas máximas aplicables al doble homicidio con agravantes, garantizando que la brutalidad del crimen y el abuso de confianza del imputado queden plenamente acreditados ante el tribunal.",
    media: "joseph1.jpg",
