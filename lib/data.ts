...
export const RC_COMUNICADOS: ComunicadoEntry[] = [
  {
    slug: "presentacion-libro-canibal-refrigeradora-asamblea-legislativa",
    title: "Más de 170 personas llenaron la Asamblea Legislativa en la presentación de «El Caníbal de la Refrigeradora»",
    seoTitle: "Presentación de «El Caníbal de la Refrigeradora» — Asamblea Legislativa",
    date: "2026-09-23",
    category: "Comunicado oficial",
    summary: "El Salón de Expresidentes de la Asamblea Legislativa se llenó con más de 170 personas para la presentación del libro del abogado penalista Joseph Rivera Cheves, realizada junto al despacho de la diputada Cindy Blanco González.",
    metaDesc: "Más de 170 personas asistieron a la presentación de «El Caníbal de la Refrigeradora» en el Salón de Expresidentes de la Asamblea Legislativa de Costa Rica.",
    keywords: [
      "presentación el caníbal de la refrigeradora",
      "el caníbal de la refrigeradora asamblea legislativa",
      "libro joseph rivera cheves",
      "salón de expresidentes asamblea legislativa",
      "cindy blanco gonzález libro",
      "nadia peraza espinoza libro",
      "presentación libro femicidio costa rica",
      "reservar el caníbal de la refrigeradora",
    ],
    image: "/images/libro/presentacion/presentacion-libro-canibal-asamblea-legislativa.webp",
    imageAlt: "Fotografía oficial de la presentación del libro «El Caníbal de la Refrigeradora» en el Salón de Expresidentes de la Asamblea Legislativa de Costa Rica, con la mesa principal y diputados sosteniendo ejemplares",
    imageCaption: "Fotografía oficial del acto en el Salón de Expresidentes de la Asamblea Legislativa, 23 de septiembre de 2026.",
    body: [
      "El bufete **Rivera Cheves & Asociados** informa que el **23 de septiembre de 2026** se realizó la presentación oficial del libro **«El Caníbal de la Refrigeradora»**, del abogado penalista **Joseph Rivera Cheves**, en el **Salón de Expresidentes de la Asamblea Legislativa de Costa Rica**. La actividad se llevó a cabo junto al **despacho de la diputada Cindy Blanco González** y convocó a **más de 170 personas**, que llenaron el salón.",
      "La mesa principal estuvo integrada por la diputada **Cindy Blanco González**, anfitriona de la actividad; **Paola Nájera**, exdiputada de la República y actual presidenta de la **Junta de Protección Social**; el diputado **Nogui Acosta Jaén**, jefe de fracción del Partido Pueblo Soberano; y el autor de la obra. El acto fue transmitido en vivo por plataformas digitales.",
      "Antes de iniciar su intervención, Rivera Cheves solicitó a los presentes guardar un **minuto de silencio** por la memoria de **Nadia Peraza Espinoza**. El autor explicó que la obra está escrita desde tres miradas —la **forense**, la **jurídica** y la **humana**— y subrayó que el libro no reproduce un expediente judicial, sino la vida de la ofendida.",
      "**El primer ejemplar, para la familia**",
      "Al cerrar su intervención, el autor entregó el **primer ejemplar de la obra a don Frank Espinoza, tío de Nadia Peraza Espinoza**, quien acompañó la actividad junto a otros familiares, amigos y vecinos de la ofendida.",
      "**Ejemplares especiales para las y los legisladores**",
      "Al término del acto, el autor entregó personalmente un **ejemplar especial** a las diputadas y diputados que acompañaron la actividad: **Cindy Blanco González**, **Nogui Acosta Jaén**, **Nayuribe Guadamuz**, **Gerald Campos**, **Eder Hernández** y **Marta Esquivel**. También acompañó la actividad el diputado **Gonzalo Ramírez**, además de autoridades, representantes institucionales y medios de comunicación.",
      "**Parte de las ganancias, para la hija de la ofendida**",
      "El autor reiteró públicamente que **parte de las ganancias del libro se destinarán a la hija de Nadia Peraza Espinoza**, hoy una niña de cuatro años, que quedó al cuidado de su familia tras la pérdida de su madre.",
      "**Cómo reservar un ejemplar**",
      "El precio del ejemplar es de **₡20.000**. La reserva se realiza mediante **SINPE Móvil al 8754-6091**, a nombre de Joseph Rivera, indicando en el detalle del SINPE el **nombre de la persona para quien se reserva** el libro. El comprobante debe enviarse por **WhatsApp al 8998-0112** y, una vez verificado el pago, la reserva queda confirmada.",
      "A partir del **24 de septiembre** se coordinan entregas mediante **Uber Flash** o se valora el envío por **Correos de Costa Rica**. El costo del traslado es adicional y depende de la modalidad y del destino: dentro de la **GAM** ronda los **₡4.000** con mensajero o **₡4.500** aproximadamente por Correos de Costa Rica. Para cotizar, la persona interesada debe remitir su dirección completa por WhatsApp al **8998-0112**.",
      "La **crónica completa del acto**, la galería de imágenes y la **transmisión íntegra** están disponibles en la página de la presentación, dentro de la sección del libro en este sitio.",
    ],
    quotes: [
      { text: "El centro de estas páginas no es quien causó el daño. El centro de estas páginas es Nadia Peraza Espinoza.", author: "Joseph Rivera Cheves", role: "Autor de la obra" },
      { text: "La memoria de la víctima no se honra con morbo, se honra con verdad y con respeto.", author: "Joseph Rivera Cheves", role: "Autor de la obra" },
      { text: "Este libro no le devuelve a su sobrina, nada podría hacerlo, pero le prometo que su nombre no se va a apagar.", author: "Joseph Rivera Cheves", role: "Al entregar el primer ejemplar a la familia" },
    ],
    tags: ["libro", "el-canibal-de-la-refrigeradora", "asamblea-legislativa", "femicidio", "joseph-rivera"],
