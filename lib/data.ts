...
export const RC_COMUNICADOS: ComunicadoEntry[] = [
  ...
  },
  {
    ...
    title: "«El Caníbal de la Refrigeradora»: el nuevo libro del abogado Joseph Rivera sobre el caso de Nadia Peraza",
    seoTitle: "«El Caníbal de la Refrigeradora» — Libro de Joseph Rivera",
    date: "2026-06-09",
    summary: "El abogado penalista Joseph Rivera anuncia «El Caníbal de la Refrigeradora», un libro que documenta el caso del femicidio de Nadia Peraza Espinoza. Parte de las ganancias será para Nashly, la hija de Nadia.",
    metaDesc: "Joseph Rivera anuncia «El Caníbal de la Refrigeradora», su libro sobre el caso Nadia Peraza. Parte de las ganancias será para Nashly, la hija de la víctima.",
    keywords: [
      "el caníbal de la refrigeradora",
      "libro joseph rivera nadia peraza",
      "joseph rivera libro femicidio",
      "caníbal de la refrigeradora libro",
      "nadia peraza espinoza libro",
      "libro caso nadia peraza",
      "nashly hija de nadia peraza",
      "joseph rivera abogado libro",
      "femicidio nadia peraza libro",
      "libro femicidio costa rica",
    ],
    body: [
      "El abogado penalista **Joseph Rivera** anuncia la próxima publicación de su libro **«El Caníbal de la Refrigeradora»**, una obra que documenta uno de los casos más difíciles y atroces en la historia de Costa Rica: el **femicidio de Nadia Peraza Espinoza**, joven madre cuyo cuerpo fue desmembrado y ocultado durante meses dentro de una refrigeradora.",
      "Más que una crónica judicial, el libro nace desde lo personal. Joseph Rivera escribió esta obra tras vivir el que ha sido, sin lugar a dudas, **el episodio más fuerte y desgarrador de toda su carrera profesional**. Acompañar a la familia de Nadia, enfrentarse a la crudeza de la evidencia y luchar por que este crimen no quedara impune dejó una huella imborrable en quien escribe estas páginas. La obra es el resultado de ese peso emocional convertido en palabras: un testimonio honesto del dolor, la indignación y, sobre todo, **la búsqueda incansable de justicia**.",
      "«Esto es por Nadia, por su hija y por su mamá. Por ella y por todas las que murieron a manos de un hombre. Seguimos buscando justicia», expresa el autor.",
      "**Parte de las ganancias serán para Nashly, la hija de Nadia**",
      "El abogado Joseph Rivera anuncia con especial énfasis que **una parte de las ganancias** generadas por la venta del libro será destinada directamente a **Nashly, la hija de Nadia Peraza**, ante las dificultades económicas que atraviesa su familia.",
      "La pequeña, que apenas tenía **dos años** al momento de los hechos, quedó al cuidado de su familia tras la pérdida de su madre. Con esta iniciativa, la obra no solo busca **preservar la memoria de Nadia** y visibilizar la violencia contra las mujeres en Costa Rica, sino también **brindar un apoyo concreto y tangible** a quien más sufrió esta tragedia: su hija.",
      "Contacto de prensa: Carlos Valencia · Teléfono: 6176-2496.",
    ],
    tags: ["nadia-peraza", "libro", "el-canibal-de-la-refrigeradora", "femicidio", "joseph-rivera"],
    relatedCase: "nadia-peraza",
    area: "derecho-penal",
  },
  {
