...
export const RC_CASES = [
  {
    ...
    press: [
      { medio: "Vista Oral · Tribunal de Apelación", t: "Conclusiones de la apelación: la sustracción patrimonial y la dosificación de la pena", u: "/entrevistas/conclusiones-apelacion-nadia-peraza-san-ramon" },
  ...
  {
    slug: "unibe-condena-civil-estudiantes",
    year: "2022",
    yearRange: "2015 – 2022",
    location: "Goicoechea · Costa Rica",
    status: "Condena civil firme",
    statusTone: "closed" as const,
    subjectType: "Organization" as const,
    name: "Universidad Iberoamericana (UNIBE)",
    short: "Condena civil contra la Universidad Iberoamericana (UNIBE): cerca de **₡50 millones de colones** para 27 estudiantes cuyas carreras técnicas de microbiología y laboratorio clínico nunca fueron reconocidas por el colegio profesional respectivo.",
    role: "Representación civil de 27 estudiantes afectados",
    sentence: "≈ ₡50 millones (daño moral + matrícula) · absolutoria penal por estafa",
    headline: "Cuando un título no habilita para ejercer",
    summary: "Desde 2015, la Universidad Iberoamericana (UNIBE) impartió las carreras técnicas de asistente en microbiología y asistente en laboratorio clínico sin que fueran reconocidas ante el Colegio de Microbiólogos y Químicos Clínicos de Costa Rica. Los egresados no pudieron incorporarse al colegio profesional ni ejercer la técnica para la que se habían formado. El Lic. Joseph Rivera Cheves asumió la representación civil de 27 de los 29 estudiantes originalmente querellantes, ya en la etapa de juicio.",
    hechos: "Desde **2015**, la Universidad Iberoamericana (UNIBE) impartió las carreras técnicas de **asistente en microbiología** y **asistente en laboratorio clínico** sin que estuvieran reconocidas ante el **Colegio de Microbiólogos y Químicos Clínicos de Costa Rica** — requisito indispensable para que los egresados pudieran incorporarse al colegio profesional y ejercer. Veintinueve estudiantes interpusieron la querella; dos desistieron de declarar durante el proceso.",
    desafio: "El principal reto probatorio fue de **naturaleza civil, no penal**: acreditar el daño concreto sufrido por cada estudiante sin contar con certificaciones de laboratorios que documentaran la pérdida de expectativas laborales durante un plazo determinado. Además, en la vía penal el **tipo de estafa exige la concurrencia de un engaño** —un estándar que el tribunal consideró no acreditado—, lo que exigió sostener la pretensión civil de forma independiente de la suerte del proceso penal.",
    estrategia: "El Lic. Rivera Cheves asumió la representación de los estudiantes ya en la **etapa de juicio**, sin haber redactado la querella original. La estrategia se centró en sostener la **acción civil resarcitoria** —el pago de daño moral y el reintegro de gastos de matrícula— de forma independiente de la vía penal, lo que permitió obtener una condena civil sólida incluso cuando el tribunal absolvió a los representantes de la universidad del delito de estafa.",
    media: "entrevistas/multimedios-unibe-condena-og.jpg",
    tags: ["Derecho Civil", "Educación Superior", "Consumidor", "Cobertura nacional"],
    timeline: [
      { date: "2015",           label: "Hechos",    text: "UNIBE imparte las carreras técnicas de asistente en microbiología y laboratorio clínico, sin reconocimiento ante el colegio profesional respectivo." },
      { date: "2015 — 2021",    label: "Querella",  text: "29 estudiantes interponen la demanda civil y penal; dos desisten de declarar durante el proceso." },
      { date: "2022 · Febrero", label: "Sentencia",  text: "El Tribunal Penal de Goicoechea condena civilmente a UNIBE a pagar cerca de ₡50 millones a 27 estudiantes y declara la absolutoria penal por estafa." },
    ],
    quote: "Es lamentable que por una falta de técnica jurídica los absolvieran en lo penal, pero gracias a Dios en la parte civil sí se logró esa condena, en una forma muy asertiva de parte del tribunal de juicio aquí en Goicoechea.",
    quoteContext: "Lic. Joseph Rivera Cheves · declaraciones a Multimedios Costa Rica tras la sentencia",
    press: [
      { medio: "Multimedios Costa Rica", t: "UNIBE pagará más de ₡50 millones a estudiantes por carreras técnicas no reconocidas", u: "/entrevistas/multimedios-unibe-condena-civil" },
    ],
    facts: [
      { k: "Institución",        v: "Universidad Iberoamericana (UNIBE)" },
      { k: "Rol del bufete",     v: "Representación civil de 27 estudiantes" },
      { k: "Resultado civil",    v: "≈ ₡50 millones · daño moral + matrícula" },
      { k: "Resultado penal",    v: "Absolutoria por estafa" },
      { k: "Hechos / Sentencia", v: "2015 → Feb 2022" },
      { k: "Tribunal",           v: "Penal de Goicoechea" },
    ],
    gallery: [
      {
        src: "/images/entrevistas/multimedios-unibe-condena.jpg",
        alt: "Abogado penalista Joseph Rivera Cheves declarando a Multimedios Costa Rica sobre la condena civil contra la Universidad Iberoamericana (UNIBE) — Costa Rica 2022",
        caption: "Declaraciones a Multimedios Costa Rica",
        sub: "El Lic. Rivera Cheves atiende a la prensa tras conocerse la sentencia civil contra UNIBE. Captura del reportaje de Multimedios Costa Rica, febrero de 2022.",
      },
    ],
    youtubeVideo: {
      youtubeId: "LQHEOfjWJYs",
      title: "UNIBE pagará más de ₡50 millones a estudiantes — reportaje de Multimedios Costa Rica",
      poster: "/images/entrevistas/multimedios-unibe-condena.jpg",
...
export const RC_CASES_SEO: Record<string, {
  ...
  "unibe-condena-civil-estudiantes": {
    title: "UNIBE — Condena Civil por ₡50 Millones 2022 | Abogado Joseph Rivera",
    desc: "Caso UNIBE: condena civil de ₡50 millones contra la Universidad Iberoamericana por carreras técnicas no reconocidas. Representación de 27 estudiantes por el Lic. Joseph Rivera Cheves.",
    keywords: [
      "caso unibe",
      "unibe condena",
      "universidad iberoamericana demanda",
      "unibe estudiantes microbiología",
      "joseph rivera unibe",
...
export const RC_AREAS = [
  ...
  },
  {
    ...
    d: "Estrategia legal frente a **terrorismo**, subversión y **crimen organizado** a nivel nacional e internacional. Cooperación con agencias de seguridad (**FBI · 2018**) y litigio de **derechos humanos ante la OEA** contra regímenes autoritarios. Formación certificada en **contraterrorismo, crimen organizado transnacional y consultoría política internacional**.",
    items: ["Crimen organizado transnacional","Cooperación con FBI","Terrorismo y subversión","Derechos humanos · OEA","Extradiciones","Delitos transfronterizos","Inteligencia y contrainteligencia","Consultoría política internacional"],
    long: [
      ...
      "Esta práctica está respaldada por formación certificada de la Escuela de Inteligencia & Estrategia (Goberna Analitics, Lima, Perú): los diplomas internacionales en **Contraterrorismo y Contrasubversión** (2024–2025), en **Estrategias contra el Crimen Organizado y Contraterrorismo** (2025) y en **Consultoría Política Internacional** (2025), que suman 440 horas académicas en inteligencia estratégica, geopolítica y análisis de organizaciones criminales y terroristas.",
    ],
    ...
    faqs: [
      ...
      { q: "¿Tienen formación especializada en contraterrorismo y crimen organizado?", a: "Sí. El Lic. Rivera Cheves cuenta con los diplomas internacionales en Contraterrorismo y Contrasubversión, y en Estrategias contra el Crimen Organizado y Contraterrorismo, ambos de la Escuela de Inteligencia & Estrategia (Goberna Analitics, Perú), además del Diploma Internacional del Consultor Político." },
    ],
  },
  {
...
export const RC_AREAS_SEO: Record<string, {
  ...
  "derecho-penal": {
    ...
    keys:       [
      ...
      "abogado derecho penal san jose",
      "abogado femicidio costa rica",
      "abogado homicidio costa rica",
      "querellante privado costa rica",
      "abogado delitos sexuales costa rica",
      "litigacion oral penal costa rica",
      "abogado narcotráfico costa rica",
      "abogado crimen organizado costa rica",
      "bufete penal costa rica",
      "representacion victimas penales costa rica",
      "abogado extorsion costa rica",
      "abogado estafa fraude costa rica",
      "abogado asociacion ilicita costa rica",
    ],
  ...
  "compliance-forense": {
    ...
    keys:       [
      "abogado lavado dinero costa rica",
      "compliance forense costa rica",
      "fraude corporativo costa rica",
      "abogado joseph rivera",
      "blanqueo capitales costa rica",
      "lavado activos abogado costa rica",
      "análisis forense financiero costa rica",
      "abogado SUGEF costa rica",
      "legitimación de capitales abogado costa rica",
      "enriquecimiento ilicito abogado costa rica",
      "abogado ICD costa rica",
      "defensa empresas lavado dinero costa rica",
      "compliance penal costa rica",
      "fraude empresarial abogado costa rica",
      "compliance tributario costa rica",
      "abogado delitos financieros costa rica",
      "rastreo transacciones forense costa rica",
    ],
  ...
  "derecho-corporativo": {
    ...
    keys:       [
      ...
      "constitucion sociedades costa rica",
      "abogado empresa costa rica",
      "abogado joseph rivera",
      "constituir sociedad anonima costa rica",
      "abogado pyme costa rica",
      "abogado fusiones adquisiciones costa rica",
      "fideicomiso costa rica abogado",
      "due diligence juridico costa rica",
      "beneficiarios finales ley 9986 costa rica",
      "asesoria corporativa san jose costa rica",
      "abogado startups costa rica",
  ...
  "derecho-laboral": {
    ...
    keys:       [
      ...
      "abogado despido injustificado costa rica",
      "fuero laboral costa rica",
      "abogado joseph rivera",
      "conflicto laboral costa rica",
      "demanda laboral costa rica",
      "conciliacion laboral costa rica",
      "juzgado trabajo costa rica",
      "MTSS costa rica abogado",
      "codigo trabajo costa rica abogado",
      "sala segunda costa rica abogado",
      "derechos trabajador costa rica",
      "abogado empleador costa rica",
      "preaviso liquidacion laboral costa rica",
      "fuero sindical costa rica",
      "proceso laboral costa rica",
    ],
  ...
  "derecho-notarial": {
    ...
    keys:       [
      ...
      "escritura bienes raices costa rica",
      "traspaso propiedades costa rica",
      "hipoteca abogado costa rica",
      "abogado joseph rivera",
      "testamento costa rica notario",
      "inscripcion registro nacional costa rica",
      "escritura compraventa inmueble costa rica",
      "sociedad anonima escritura notarial costa rica",
      "fideicomiso garantia costa rica",
      "poder notarial mandato costa rica",
      "autenticacion documentos costa rica",
      "notario san jose costa rica",
      "traspaso vehiculo notarial costa rica",
      "constitucion hipoteca notarial costa rica",
      "beneficiarios finales registro accionistas",
    ],
    photo:      "/images/joseph/retrato.jpg",
  ...
  "asesoria-internacional": {
    ...
    keys:       [
      "abogado crimen organizado costa rica",
      "extradicion costa rica abogado",
      "cooperacion internacional costa rica",
      "abogado joseph rivera",
      "litigacion cidh",
      "CIDH OEA denuncia costa rica",
      "derechos humanos abogado costa rica",
      "delitos transfronterizos costa rica",
      "asistencia judicial reciproca costa rica",
      "abogado terrorismo subversion costa rica",
      "proceso extradicion pasiva costa rica",
      "comision interamericana derechos humanos abogado",
      "litigacion internacional penal costa rica",
      "crimen organizado transnacional abogado",
      "cooperacion FBI costa rica",
      "abogado regimenes autoritarios centroamerica",
      "asesor estrategico contraterrorismo costa rica",
      "diploma internacional crimen organizado",
      "consultor politico internacional costa rica",
      "inteligencia estrategica contraterrorismo",
    ],
    photo:      "/images/joseph7.jpg",
    credential: "Asesor Estratégico Internacional en Contraterrorismo y Crimen Organizado (Goberna Analitics, Perú) · Cooperación con el FBI (2018) · Litigación ante la CIDH-OEA",
  },
  "casacion-penal": {
    ...
    keys:       [
      "casacion penal costa rica",
      "sala tercera costa rica abogado",
      "recurso casacion penal",
      "abogado joseph rivera",
      "impugnacion sentencia costa rica",
      "sala tercera corte suprema costa rica",
      "recurso casacion plazo costa rica",
      "defensa condena penal costa rica",
      "nulidad sentencia penal costa rica",
      "litigacion recursiva costa rica",
      "recurso de revision penal costa rica",
      "vicio de prueba casacion costa rica",
      "abogado sala tercera costa rica",
      "apelacion sentencia penal costa rica",
      "inadmision recurso casacion",
      "impugnacion fallo tribunal penal costa rica",
    ],
    photo:      "/images/joseph/prensa-tribunales.jpg",
...
export const RC_PRESS: PressEntry[] = [
  ...
  {
    medio: "Vista Oral",    year: "2026", date: "2026-07-15",   type: "entrevista", lang: "es",
    t: "Conclusiones de la apelación: caso Nadia Peraza, Tribunal de San Ramón",
    u: "/entrevistas/conclusiones-apelacion-nadia-peraza-san-ramon",
    desc: "Joseph Rivera expone sus conclusiones como querellante: la sustracción patrimonial no valorada en la dosificación de la pena.",
    image: "/images/entrevistas/conclusiones-apelacion-og.jpg",
  },
  {
    ...
    desc: "El penalista explica la figura del femicidio, sus penas y la reforma de 2022, y anuncia «El Caníbal de la Refrigeradora», su libro sobre uno de los casos más atroces del país.",
...
export const RC_ENTREVISTAS: EntrevistaEntry[] = [
  ...
  },
  {
    ...
    medio: "Vista Oral",
    title: "Conclusiones de la apelación del caso Nadia Peraza",
    desc:  "Joseph Rivera expone ante el Tribunal de San Ramón por qué la sustracción patrimonial debió pesar en la pena.",
    date:  "2026-07-15",
    image: "/images/entrevistas/conclusiones-apelacion-og.jpg",
  },
  {
...
export const RC_FORMACION = [
  ...
  { t: "Lead Auditor Course · ISO 31000:2018 — Gestión de Riesgos",         s: "INTERCERT LATAM · 2026",                d: "Certificación de nivel avanzado para **dirigir equipos de auditoría**, planificar y ejecutar **auditorías completas** de sistemas de gestión de riesgos, coordinar auditorías y emitir informes." },
  { t: "Internal Auditor Course · ISO 31000:2018 — Auditoría Interna",      s: "INTERCERT LATAM · 2026",                d: "Certificación de nivel intermedio para realizar **auditorías internas**, verificar cumplimiento normativo, detectar riesgos y elaborar informes técnicos." },
  { t: "Interpretation of the Standard · ISO 31000:2018",                   s: "INTERCERT LATAM · 2026",                d: "Base técnica para **interpretar la norma ISO 31000**, asesorar sobre su implementación y explicar sus requisitos en materia de gestión de riesgos." },
  { t: "Diploma Internacional del Consultor Político — Consultor Político Internacional", s: "Escuela de Inteligencia & Estrategia · Goberna Analitics, Lima, Perú · Julio – Agosto 2025", d: "**120 horas académicas** en estrategia de campañas electorales: war room y dirección estratégica, **inteligencia aplicada a campañas y gobierno**, cartografía electoral, oratoria política y media training, **IA aplicada a elecciones** y lawfare." },
  { t: "Diploma Internacional en Estrategias contra el Crimen Organizado y Contraterrorismo — Asesor Estratégico", s: "Escuela de Inteligencia & Estrategia · Goberna Analitics, Lima, Perú · Marzo – Abril 2025", d: "**200 horas académicas** (nota 19/20). **Inteligencia y contrainteligencia** aplicada a organizaciones criminales, delincuencia transnacional y control del sistema penitenciario frente al **crimen organizado**." },
  { t: "Diploma Internacional en Contraterrorismo y Contrasubversión — Asesor Estratégico Internacional", s: "Escuela de Inteligencia & Estrategia · Goberna Analitics, Lima, Perú · Diciembre 2024 – Enero 2025", d: "**120 horas académicas** (nota 20/20). Geopolítica, fundamentalismo y métodos de adoctrinamiento, e **inteligencia estratégica aplicada al contraterrorismo** y su conexión con el crimen organizado." },
...
export const RC_COMUNICADOS: ComunicadoEntry[] = [
  ...
  {
    slug: "vista-oral-apelacion-nadia-peraza",
    ...
    keywords: [
      ...
      "apelación femicidio nadia peraza",
      "jeremy buzano paisano apelación",
      "tribunal apelación san ramón",
      "caso nadia peraza 2026",
      "joseph rivera cheves apelación",
      "femicidio costa rica apelación",
      "expediente 24-001572-0059-PE",
      "proyecto de ley nadia",
      "timbre nadia",
      "vista oral femicidio costa rica julio 2026",
    ],
    body: [
      "San Ramón, Alajuela. — El **Tribunal de Apelación de Sentencia del Tercer Circuito Judicial de Alajuela, Sección Segunda**, ha señalado **Vista Oral para el 15 de julio de 2026 a las 9:00 a.m.**, en la Sala de Audiencias número tres del segundo piso de los Tribunales de Justicia de San Ramón, en el marco del proceso penal por el **femicidio de Nadia Jeannette Peraza Espinoza** (Expediente N.° 24-001572-0059-PE).",
      "La audiencia resuelve los **Recursos de Apelación** interpuestos por las partes tras la sentencia dictada el 20 de marzo de 2026 por el Tribunal Penal de Heredia, que condenó a **Jeremy Mauricio Buzano Paisano a 79 años de prisión** por los delitos de femicidio, suplantación de identidad, sustracción patrimonial y estafa informática. Entre los recursos admitidos figura el interpuesto por la defensa del imputado. El **Msc. Joseph Alfonso Rivera Cheves**, en su condición de Abogado Director de la Querella y Acción Civil, representa los intereses de la familia de la víctima en esta etapa procesal.",
      "Los jueces designados para resolver la apelación son **Jorge Steve Fernández Rodríguez**, **Jorge Luis Morales García** y la jueza **María Gabriela Rodríguez Morales**.",
      "El Msc. Joseph Rivera Cheves, Abogado Director de la Querella y Acción Civil, declaró: «La sentencia de 79 años dictada en marzo fue una victoria importante, pero **el proceso continúa**. La defensa del condenado ha interpuesto recurso de apelación, y estaremos presentes en esta Vista Oral para **defender la condena en todos sus extremos**. Seguimos en los tribunales, como lo hemos hecho desde el primer día, **hasta que se haga justicia plena**».",
      "**Antecedentes del caso**",
      "**Nadia Jeannette Peraza Espinoza**, de 21 años, fue reportada como desaparecida el 1.° de marzo de 2024. Su cuerpo desmembrado fue hallado el 17 de mayo de ese mismo año dentro de una refrigeradora en una vivienda en San Pablo de Heredia y en un lote baldío en Bajo de los Molinos. Jeremy Mauricio Buzano Paisano, expareja de la víctima y padre de su hija de tres años, fue señalado desde el inicio como responsable del crimen.",
      "El juicio oral se extendió del **18 de febrero al 18 de marzo de 2026**. Durante el proceso se acreditó que Buzano asesinó a Nadia, desmembró su cuerpo a lo largo de tres meses y utilizó su teléfono celular y sus tarjetas bancarias para hacerse pasar por ella ante familiares y amigos, llegando incluso a solicitar transferencias de dinero vía **SINPE Móvil** al hermano de la víctima.",
      "El despacho **Rivera Cheves & Asociados** asumió la representación de la familia ejerciendo la Querella y Acción Civil. La madre de Nadia, **Marilyn Espinoza**, estuvo presente en la lectura de sentencia junto al Msc. Rivera Cheves.",
      "Este caso motivó además el **Proyecto de Ley Nadia**, iniciativa legislativa impulsada por el Msc. Rivera Cheves ante la Asamblea Legislativa de Costa Rica, que busca endurecer las penas por femicidio y homicidio doloso, eliminar beneficios penitenciarios anticipados y crear el **Timbre Nadia** como mecanismo de reparación para familias de víctimas de crímenes violentos.",
      "**Datos de la audiencia**",
      "**Acto procesal** — Vista Oral, Recursos de Apelación de Sentencia.",
      "**Expediente** — 24-001572-0059-PE.",
      "**Imputado** — Jeremy Mauricio Buzano Paisano.",
      "**Delito** — Femicidio y otros.",
      "**Ofendida** — Nadia Jeannette Peraza Espinoza.",
      "**Fecha y hora** — 15 de julio de 2026, 9:00 a.m.",
  ...
  {
    slug: "libro-el-canibal-de-la-refrigeradora",
    ...
    keywords: [
      ...
      "libro joseph rivera",
      "joseph rivera libro femicidio",
      "caníbal de la refrigeradora libro",
      "libro true crime costa rica",
      "cronica forense costa rica",
      "joseph rivera abogado libro",
      "libro femicidio costa rica",
    ],
    body: [
      "El abogado penalista **Joseph Rivera** anuncia la próxima publicación de su libro **«El Caníbal de la Refrigeradora»**, una obra que documenta uno de los casos más difíciles y atroces en la historia de Costa Rica: el **femicidio de la ofendida**, una joven madre cuyo cuerpo fue desmembrado y ocultado durante meses dentro de una refrigeradora.",
      "Más que una crónica judicial, el libro nace desde lo personal. Joseph Rivera escribió esta obra tras vivir el que ha sido, sin lugar a dudas, **el episodio más fuerte y desgarrador de toda su carrera profesional**. Acompañar a la familia de la ofendida, enfrentarse a la crudeza de la evidencia y luchar por que este crimen no quedara impune dejó una huella imborrable en quien escribe estas páginas. La obra es el resultado de ese peso emocional convertido en palabras: un testimonio honesto del dolor, la indignación y, sobre todo, **la búsqueda incansable de justicia**.",
      "«Esto es por ella, por su hija y por su mamá. Por ella y por todas las que murieron a manos de un hombre. Seguimos buscando justicia», expresa el autor.",
  ...
  },
  {
    ...
    keywords: [
      "junieysis merlo hijas",
      "custodia hijas junieysis merlo",
      "joseph rivera junieysis merlo",
      "hijas junieysis merlo nicaragua",
      "caso junieysis merlo 2026",
      "femicidio junieysis merlo",
      "vilma abuela junieysis merlo",
      "interés superior de las niñas costa rica",
      "rivera cheves asociados junieysis merlo",
      "custodia menores femicidio costa rica",
    ],
    body: [
  ...
  {
    slug: "sala-tercera-admite-recurso-casacion-joseph-rivera",
    title: "Joseph Rivera logra que la Sala Tercera admita un recurso de casación penal",
    seoTitle: "Sala Tercera Admite Recurso de Casación | J. Rivera",
    date: "2026-07-30",
    category: "Actualización procesal",
    summary: "El Lic. Joseph Rivera Cheves logró que la Sala Tercera de la Corte Suprema de Justicia admitiera a trámite un recurso de casación penal, al considerar que existen elementos que ameritan un análisis de fondo sobre la acreditación de un elemento subjetivo del delito y el principio de inocencia.",
    metaDesc: "El Lic. Joseph Rivera Cheves logra que la Sala Tercera admita a trámite un recurso de casación penal, un resultado poco frecuente en esta etapa procesal.",
    body: [
      "El Lic. **Joseph Rivera Cheves**, del bufete **Rivera Cheves & Asociados**, logró que la **Sala Tercera de la Corte Suprema de Justicia** admitiera a trámite un recurso de casación penal planteado en su condición de defensor particular. La mayoría de los recursos de casación son rechazados en esta etapa, por lo que la admisión representa **un logro técnico significativo** para la defensa.",
      "La Sala consideró que existen elementos que ameritan un análisis de fondo sobre la forma en que se acreditó un elemento subjetivo del delito —la intención con la que se atribuye la conducta— sin apoyo en prueba pericial o técnica suficiente, lo que plantea un posible roce con el **principio de inocencia** y la regla del **in dubio pro reo**: ante la duda razonable, debe favorecerse a la persona imputada.",
      "El recurso de casación exige superar un filtro de admisibilidad antes de que la Sala analice el fondo de los argumentos. Que un motivo sea admitido —y no descartado de plano, como ocurre con la mayoría— significa que la Sala Tercera reconoció **mérito jurídico suficiente** en el planteamiento de la defensa para estudiarlo con detenimiento.",
      "El caso continúa su trámite: corresponde ahora a la Sala Tercera resolver el fondo del motivo admitido. Por involucrar a personas menores de edad, el bufete se abstiene de brindar mayores detalles que puedan identificar a las partes.",
      "**Rivera Cheves & Asociados** cuenta con una práctica especializada en casación penal ante la Sala Tercera, y celebra este avance como reflejo del rigor técnico que exige la litigación recursiva.",
    ],
    tags: ["casacion-penal", "sala-tercera", "principio-de-inocencia", "defensa-penal-especializada"],
    keywords: [
      "recurso de casación penal costa rica",
      "sala tercera corte suprema costa rica",
      "principio de inocencia",
      "in dubio pro reo",
      "abogado casación penal costa rica",
      "defensor particular casación",
    ],
    area: "casacion-penal",
